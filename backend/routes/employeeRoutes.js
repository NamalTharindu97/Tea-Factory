...
const { getEmployee, getSingleEmployee, createEmployee, updateEmployee, deleteEmployee, loginEmployee, currentEmployee, getEmpCount, getEmployeeCount } = require("../controllers/employeeController");
