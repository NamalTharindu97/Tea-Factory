...
const { getEmployee, getSingleEmployee, createEmployee, updateEmployee, deleteEmployee, loginEmployee, currentEmployee, getEmpCount } = require("../controllers/employeeController");
